...
def process_images(image_folder=None):
    ...
    if image_folder is None:
        image_folder = os.getenv('IMAGES_PATH', 'images')
...
def visualize_top_skills(skill_counts, top_n=20):
    ...
    # Save the chart
    plt.savefig('output/top_skills.png')
    print(f"Chart saved to output/top_skills.png")
...
def save_results(skill_counts):
    ...
    output_file = 'output/skill_analysis.csv'
    ...
    try:
        ...
        alt_file = 'output/skill_analysis_new.csv'
        try:
